...
Clone this repo into your documents folder. In the command prompt, cd into your documents folder cd %USERPROFILE%\documents. Make sure that you are in the correct folder. Type git clone your-repo-url (Get your repo url from github after creating the repo). Then cd into the folder you have just cloned by typing cd week10Lab-yourgithubid. Once you are in the correct folder, keep this command window open so you can type in your git commands as required.
